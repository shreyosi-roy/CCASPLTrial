...
public class RelieverDatabaseHelper extends SQLiteOpenHelper {

    //database name
    public static final String DB_NAME="CCASPL_OPERATIONS_APP_RELIEVER.db";
    ...
    public RelieverDatabaseHelper(Context context, int versionCount) {
    ...
    public ArrayList<MaterialsModel> getMaterials()
    {
        ...
        Cursor result=myDB.query(MATERIAL_TABLE, new String[]{COL_MATERIAL_ID, COL_MATERIAL_CODE,
                        COL_MATERIAL_NAME, COL_UNIT_QUANTITY, COL_MATERIAL_RATE,
                        COL_BALANCE_AMOUNT, COL_REQUIREMENT_STATUS, COL_REQUIRED_AMOUNT}, null,
                null, null, null, null);
